...
- 💻 **تبويب "مواصفاتي"** يعرض المعالج وكرت الشاشة والرامات واللوحة الأم والتخزين والنظام، مع زر نسخ للمشاركة، ويتحقق إذا تعريف كرت الشاشة يحتاج تحديث (تلقائي لكروت NVIDIA)، ويعرض حرارة كرت NVIDIA واستخدامه مباشرة
